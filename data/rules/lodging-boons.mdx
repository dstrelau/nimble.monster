---
title: "Lodging Boons"
keywords: ["boon", "term", "temporary", "typically"]
sources:
  - book: "GMG v1"
    pages: [21]
---
...
These Boons are temporary and last only until the heroes take another Safe Rest. Adjust the cost and impact to suit your campaign and the party’s level of health.

| **1d8** | Temporary Boon                  |
| ------- | ------------------------------- |
| 1       | Recover 2 additional {{term:Wounds}}     |
| 2       | Gain LVL temp HP                |
| 3       | Gain KEY temp {{term:Hit Dice}}          |
| 4       | +1 {{term:Speed}}                        |
| 5       | Inspired (reroll any die, once) |
| 6       | {{term:Advantage}} vs. Fear/Charm/Etc.   |
