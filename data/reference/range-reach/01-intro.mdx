...
* In Melee. If any enemy is adjacent to you, your Ranged attacks are made with {{term:disadvantage}} (Reach attacks are not so affected).
* Long Range. You can gain {{term:disadvantage}} 1 to gain +2 Range on any Ranged attack (max +6).
