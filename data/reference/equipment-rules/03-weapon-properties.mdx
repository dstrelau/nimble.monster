---
slug: "equipment-rules__weapon-properties"
...
* **Range.** Attacks can be made from afar. If any enemy is adjacent to you, your Ranged attacks are made with {{term:disadvantage}}. Add 1 die of {{term:disadvantage}} to gain +2 Range.
