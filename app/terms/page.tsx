    ...
    <>
      <div className="prose dark:prose-invert">
        ...
        <p>
          ...
          however, you grant nimble.monster a non-exclusive, worldwide license
          to host, store, and display your content as necessary to provide the
          Service.
        </p>
        <p>
        ...
        <p>
          Content marked as "public" may be viewed by all users.Public content
          may be featured or promoted within the Service. You understand that
        ...
        <p>
          <strong>TO THE FULLEST EXTENT PERMITTED BY LAW:</strong> THE SERVICE
          ...
          LIABILITY SHALL NOT EXCEED $100 OR THE AMOUNT YOU PAID FOR THE SERVICE
          (IF ANY). WE ARE NOT RESPONSIBLE FOR DATA LOSS, SERVICE INTERRUPTIONS,
        ...
        <p>
          You may stop using the Service at any time. Account deletion may
          result in permanent loss of your content. We may terminate or suspend
